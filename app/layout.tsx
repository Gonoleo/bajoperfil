...
export const metadata: Metadata = {
  title: {
    default: "BajoPerfil.gg - Eventos Gaming en Español",
    template: "%s | BajoPerfil.gg",
  },
  description:
  ...
  openGraph: {
    ...
    title: "BajoPerfil.gg - Eventos Gaming en Español",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "BajoPerfil.gg - Eventos Gaming NYC",
      },
    ],
  },
  twitter: {
