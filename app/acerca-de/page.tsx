...
const responsiveStyles = `
  .bp-hero { padding: 56px 24px 32px; }
  .bp-search-wrap { max-width: 480px; margin: 0 auto 24px; padding: 0 24px; }
  .bp-pills { display: flex; flex-wrap: wrap; gap: 10px; justify-content: center; padding: 0 24px 32px; }
  @media (max-width: 640px) {
    .bp-hero { padding: 36px 16px 24px; }
    .bp-search-wrap { padding: 0 16px; }
    .bp-pills { flex-wrap: nowrap; overflow-x: auto; justify-content: flex-start; padding: 0 16px 24px; -webkit-overflow-scrolling: touch; scrollbar-width: none; }
    .bp-pills::-webkit-scrollbar { display: none; }
    .bp-pills button { flex-shrink: 0; }
    .bp-map-section { padding: 0 12px 40px !important; }
  }
`;
      ...
      <div className="bp-pills">
        <button
          ...
          style={{
            ...
            fontSize: '12px',
            fontWeight: 600,
            color: !categoryFilter ? '#0f0b1a' : '#f5f3ff',
            background: !categoryFilter ? '#f5f3ff' : 'rgba(255,255,255,0.05)',
            ...
            >
              <span
                style={{
                  ...
                  height: '9px',
                  borderRadius: '50%',
                  background: active ? '#0f0b1a' : cat.color,
                  flexShrink: 0,
                }}
              />
              {cat.label}
